...
namespace Microsoft.Recognizers.Definitions.Chinese
{
	...
	public static class NumbersDefinitions
	{
		...
		public static readonly string NumbersWithDozen = $@"{AllIntRegex}[双雙对對打](?!{AllIntRegex})";
		...
		public static readonly string NumbersPercentageWithMultiplierRegex = $@"(?<!{ZeroToNineIntegerRegex})[百佰]\s*分\s*之\s*{ZeroToNineFullHalfRegex}+[\.．]{ZeroToNineFullHalfRegex}+\s*(K|k|M|G|T|Ｍ|Ｋ|ｋ|Ｇ|Ｔ)";
		...
		public static readonly string FractionPercentageWithMultiplierRegex = $@"{ZeroToNineFullHalfRegex}+[\.．]{ZeroToNineFullHalfRegex}+\s*(K|k|M|G|T|Ｍ|Ｋ|ｋ|Ｇ|Ｔ)\s*[个個]\s*[百佰]\s*分\s*[点點]";
		...
		public static readonly string SimpleNumbersPercentageWithMultiplierRegex = $@"(?<!{ZeroToNineIntegerRegex})[百佰]\s*分\s*之\s*{ZeroToNineFullHalfRegex}+\s*(K|k|M|G|T|Ｍ|Ｋ|ｋ|Ｇ|Ｔ)";
